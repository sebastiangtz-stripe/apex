...
The agent writes data/hubble-snapshot.json by running the tuned SQL template
(templates/hubble-query.sql, {{LEAD_FILTER}} substituted) via run_hubble_query
MCP tool and filtering results locally.
